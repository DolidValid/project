...
const ImportBatch = ({ type, fileId, executionDate }) => {
  ...
  // Create an auto-fallback ID for specific screens (like UpdateRatePlan) that skip InfoFile entirely
  ...
  const handleSubmit = async (e) => {
    ...
    const masterPayload = {
      executionDate: executionDateFromParent, // Accurately reflects what user picked in InfoFile
